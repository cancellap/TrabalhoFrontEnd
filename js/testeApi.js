...
async function getJoke() {
    ...
    function sortCatego() {
        const catego = ["animal", "career", "celebrity", "dev", "fashion", "food", "history", "money", "movie", "music", "political", "religion", "science", "sport", "travel"]
    ...
    const palavras = ["porn", "sex"]
    let joke = jokeData.value;
    if (joke.includes(palavras)) {
        blackList.push(joke);
        return getJoke();
    }
